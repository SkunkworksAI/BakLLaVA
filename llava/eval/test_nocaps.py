...
if __name__ == "__main__":
    ...
    img_ids = [{"id":r["image_id"], "file_name": r["image_id"]} for r in results]

    res_file = os.path.join(eval_dir, "result_nocaps.json")
    ...
    ann_path = "/p/scratch/ccstdl/marianna/bakllava/eval_data/nocaps/captions.json"
